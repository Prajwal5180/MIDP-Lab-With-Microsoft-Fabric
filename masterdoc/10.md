...
- Created a new data pipeline using the Fabric Data Factory.

- Configured an HTTP connection to import the WWI dataset.

- Successfully ingested the data into the lakehouse and organized it under the wwi-raw-data folder.
