...
13. Once you are in the **Add role assignment** pane, select scope to **Workspace (1)**, select **Synapse Administrator (2)** role from the dropdown, search for the user which you are using in this session and select that **user (3)** and click on **Apply (4)**.
...
24. Click on the **+** button for creating a new table, and name it as **Thermostat**. Upon opening the **Configure the data source** page, choose the default **subscription** from the dropdown list in the Subscription section. 
