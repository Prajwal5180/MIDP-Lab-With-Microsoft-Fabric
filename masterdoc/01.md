...
2. On the "Keep your account secure" page, select Next twice.
3. Note: If you don’t have the Microsoft Authenticator app installed on your mobile device:
◦ Open Google Play Store (Android) or App Store (iOS).
◦ Search for Microsoft Authenticator and tap Install.
◦ Open the Microsoft Authenticator app, select Add account, then choose Work or school account.
4. A QR code will be displayed on your computer screen.
5. In the Authenticator app, select Scan a QR code and scan the code displayed on your screen.
6. After scanning, click Next to proceed.
7. On your phone, enter the number shown on your computer screen in the Authenticator app and select Next.
8. If prompted to stay signed in, you can click "No."
9. If a Welcome to Microsoft Azure pop-up window appears, simply click "Maybe Later" to skip the tour.
